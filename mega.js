function hello(){
 ...
 function mac(){
    ...
    <ul>
        ...
        <li><a href="#"><h1>Mac pro</h1></a></li>
      
        <li><a href="#"><h1>iMac</h1></a></li>
        <li><a href="#"><h1>Display</h1></a></li>
        <li><a href="#">compare Mac</a></li>
        <li><a href="#">Mac Does That</a></li>
 ...
 function vision(){
    ...
    document.getElementById('finaloutput').innerHTML= link5;
 }
 function watch(){
    ...
    <li><a href="#"><h4>Get AppleCare+</h4></a></li>
    <li><a href="#"><h4>Apple ID & Password</h4></a></li>
    <li><a href="#"><h4>Find My</h4></a></li>
    <li><a href="#"><h4>Accessibility</h4></a></li>
    ...
    document.getElementById('finaloutput').innerHTML= link6;
 }
 ...
 function teli(){
    ...
    document.getElementById('finaloutput').innerHTML= link7;
 }
 function enter(){
    let link8=`<div id="enter">
    <ul>
    <li><a href="#">Explore Support</a></li>
    <li><a href="#"><h1>iphone</h1></a></li>
    <li><a href="#"><h1>Mac</h1></a></li>
...
<ul>
    ...
    document.getElementById('finaloutput').innerHTML= link8;
 }
 function access(){
    let link9=`   <div id="acces">
    <ul>
   >
        <li><a href="#">Support</a></li>
        <li><a href="#"><h1>iMac</h1></a></li>
    ...
    document.getElementById('finaloutput').innerHTML= link9;
 }
 
 function support(){
    let link10=`   <div id="sup">
    <ul>
        <li><a href="#">Explore Support</a></li>
        <li><a href="#"><h1>iphone</h1></a></li>
        <li><a href="#"><h1>Mac</h1></a></li>
    ...
    document.getElementById('finaloutput').innerHTML= link10;
 }
